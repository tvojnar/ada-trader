...
const Quote = Backbone.Model.extend({
  ...
  // the buy() function increases the price of a stock by $1.00 when the 'buy' button for the stock is clicked
  ...
  buy() {
    ...
    // return the currentPrice so I can send it to the TradeHistoryView from the QuoteView buyStock function on the bus
    return currentPrice
  },


  // the sell() function decreases the price of a stock by $1.00 when the 'sell' button for the stock is clicked
  ...
  sell() {
    ...
    // return the sellPrice so I can send it to the TradeHistoryView from the QuoteView sellStock function on the bus
    return sellPrice;
  },
});
